...
| Windows Companion                    | **Unsigned engineering preview**                  | A self-contained `win-x64` CLI verifies and installs the canonical release archive, creates a secret-bearing local config without echoing it, reports recommended install locations and performs offline diagnostics. It does not mutate Docker, WSL, VHDX or system services.                                                                                                               |
