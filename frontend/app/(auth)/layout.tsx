...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="relative grid min-h-screen overflow-hidden bg-background lg:grid-cols-[minmax(36rem,1.12fr)_minmax(28rem,.88fr)]">
      ...
      <section className="relative hidden overflow-hidden border-r border-white/10 bg-black px-10 py-8 text-white lg:flex lg:flex-col xl:px-14 xl:py-10">
      ...
      <section className="relative flex min-h-screen items-center justify-center bg-white px-4 py-20 text-black dark:bg-black dark:text-white sm:px-8">
        <div className="absolute inset-x-0 top-0 h-px bg-foreground lg:hidden" />
