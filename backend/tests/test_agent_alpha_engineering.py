...
gateway and head 0015 may assemble the DB-backed service.
"""
...
class _FakeFactory:
    def __init__(self, *, head: str | None = "0015", raise_on_call: bool = False) -> None:
        self._head = head
    ...
    def __call__(self) -> _FakeSession:
        ...
        return _FakeSession(_HeadRow() if self._head == "0015" else _MissingHeadRow())
...
def test_migration_head_not_0015_returns_unavailable() -> None:
    result = build_engineering_agent_alpha(
        flag="true",
        settings=_settings("development"),
