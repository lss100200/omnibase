...
SOURCE_PATHS = (
    ...
    "backend/src/omnibase/migrations/versions/0014_first_party_skills.py",
...
def _record(
    ...
    *,
    ...
    report: dict[str, object] = {
        ...
        "migration_head": "0016" if passed else None,
    ...
    _write(
        ...
        "\n".join(
            (
                ...
                "- Migration head: 0016; migrations 0013 and 0016 created",
